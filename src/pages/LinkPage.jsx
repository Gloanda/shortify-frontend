    ...
    <>
      ...
      <div className="flex flex-col gap-8 sm:flex-row justify-between">
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
          ...
          <a
            href={`https://shortify.gloanda.com/${link}`}
            target="_blank"
            className="text-1xl sm:text-2xl text-blue-400 font-bold hover:underline cursor-pointer"
          >
            https://shortify.gloanda.com/{link}
          </a>
          <a
